...
clamp_upper = 0.01
is_crop = True
sample_dir = '/home/jinlin/tensorflow/GAN/WGAN/DCGAN_128/picture1'
...
D, D_logits = discriminator(images, batch_size)
tf.histogram_summary('D', D)

_sample = sampler(z, image_size, batch_size)
D_, D_logits_ = discriminator(G, batch_size, reuse=True)
